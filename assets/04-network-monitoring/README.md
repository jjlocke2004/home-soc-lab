...
### Importing the Wazuh Agent Enrollment Key

Imported the enrollment key generated by the Wazuh manager onto the Zeek VM, registering the system as agent ID `003`.

> **Security note:** The enrollment key is visible in this screenshot. It should be covered or cropped before the image is included in a public repository.

![Importing the Wazuh Agent Key](<screenshots/entering-key-from-agent-manager.png>)
